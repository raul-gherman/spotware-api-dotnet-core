...
namespace spotware
{
    public partial class Client
    {
        private void Process_Execution_Event()
        {
            ...
            {
                executionEvent += $"positionId: {args.Position.positionId}; "                                     +
            ...
            if (args.Deal != null)
            {
                executionEvent += $"dealId: {args.Deal.dealId}; "                                                                                     +
            ...
            {
                executionEvent += $"bonusDepositWithdraw.operationType: {args.bonusDepositWithdraw.operationType}; "               +
