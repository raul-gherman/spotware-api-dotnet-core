        ...
        private void Process_Execution_Event()
        {
            ...
            if (args.Order != null)
            {
                string executionEvent = "ProtoOAExecutionEvent:: "                                                                                                                                                  +
                                        ...
                                        $"tradeData.symbolId: {args.Order.tradeData.symbolId} ({TradingAccounts[args.ctidTraderAccountId].TradingSymbols[args.Order.tradeData.symbolId].LightSymbol.symbolName}); " +
            ...
            if (args.Position != null)
            {
                string executionEvent = "ProtoOAExecutionEvent:: "                                                                                                                                                        +
                                        ...
                                        $"tradeData.symbolId: {args.Position.tradeData.symbolId} ({TradingAccounts[args.ctidTraderAccountId].TradingSymbols[args.Position.tradeData.symbolId].LightSymbol.symbolName}); " +
            ...
            if (args.Deal != null)
            {
                string executionEvent = "ProtoOAExecutionEvent:: "                                                                                                                  +
                                        ...
                                        $"symbolId: {args.Deal.symbolId} ({TradingAccounts[args.ctidTraderAccountId].TradingSymbols[args.Deal.symbolId].LightSymbol.symbolName}); " +
