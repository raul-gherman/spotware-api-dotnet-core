...
namespace spotware
{
    public partial class Client
    {
        private void Process_Reconcile_Res()
        {
            ...
            TradingAccounts[args.ctidTraderAccountId].Positions.Clear();
            ...
            foreach (ProtoOAPosition position in args.Positions)
            {
                ...
                string item = $"positionId: {position.positionId}; "                                                                                +
                              ...
                              $"({TradingAccounts[args.ctidTraderAccountId].TradingSymbols[position.tradeData.symbolId].LightSymbol.symbolName}); " +
            ...
            TradingAccounts[args.ctidTraderAccountId].Orders.Clear();
            ...
            foreach (ProtoOAOrder order in args.Orders)
            {
                ...
                string item = $"orderId: {order.orderId}; "                                                                                      +
                              ...
                              $"({EpochToString(order.tradeData.openTimestamp)}); "                                                              +
                              $"tradeData.symbolId: {order.tradeData.symbolId} "                                                                 +
                              $"({TradingAccounts[args.ctidTraderAccountId].TradingSymbols[order.tradeData.symbolId].LightSymbol.symbolName}); " +
